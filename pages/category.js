...
import VegetableData from '../components/Data/VegetableData'
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative z-10 flex items-baseline justify-between pt-5 pb-2 border-b border-gray-200">
            <h1 className="text-2xl font-extrabold tracking-tight text-green-600">Fresh Vegetable</h1>
