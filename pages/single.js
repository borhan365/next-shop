              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  ...
                  <RadioGroup value={selectedSize} onChange={setSelectedSize} className="mt-4">
                    ...
                    <div className="grid grid-cols-8 gap-2 sm:grid-cols-8 lg:grid-cols-8">
                        ...
                        <RadioGroup.Option
                          ...
                          className={({ active }) =>
                            classNames(
                              ...
                              'group relative border rounded-md h-10 w-16 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6'
                            )
                          }
                        >
                          {({ active, checked }) => (
